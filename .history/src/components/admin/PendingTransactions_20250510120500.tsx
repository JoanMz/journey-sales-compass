...
const PendingTransactions = () => {
  ...
  const fetchPendingTransactions = async () => {
    try {
      ...
      const response = await axios.post("https://xc7xrbwd2unlgl2pq5zha6lw2i0hbwzd.lambda-url.us-west-2.on.aws/",{"url": "http://ec2-35-90-236-177.us-west-2.compute.amazonaws.com:3000/transactions/filter/pendiente","method": "GET"});
